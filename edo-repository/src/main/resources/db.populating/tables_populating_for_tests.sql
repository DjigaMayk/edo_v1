...
insert into edo.employee (first_name, last_name, middle_name, address, photo_url, fio_dative, fio_nominative, fio_genitive,
...
insert into edo.author (first_name, last_name, middle_name, address, snils, mobile_phone, email, employment, fio_dative,
...
insert into edo.address (full_address, street, house, "index", housing, building, city, region, country, flat)
