...
DO $$
    BEGIN
        IF NOT EXISTS (
            ...
            WHERE table_name = 'approval_sheet'
              AND constraint_name = 'fk_approval_sheet_on_parent_approval_sheet'
        ) THEN
            ALTER TABLE approval_sheet
                ADD CONSTRAINT FK_APPROVAL_SHEET_ON_PARENT_APPROVAL_SHEET
                    FOREIGN KEY (parent_approval_sheet)
                        REFERENCES approval_sheet (id);
        END IF;
    END $$;
